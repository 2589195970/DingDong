<template>
	<view class="page-container">
		...
		<u-modal :show="commissionopen" @confirm="confirm" ref="uModal" @cancel="cancel" :showCancelButton='true'
			confirmText="确认" :asyncClose="true" style="line-height: 40px;">
			下游佣金：
			<u--input placeholder="下游佣金" border="surround" v-model="frme.distributionProductCommission"
				@change="change"></u--input>
		</u-modal>
		<u-popup :show="show" @close="close" @open="open" :round="10">
			<view style="height: 300rpx; text-align: center;">
...
<script>
	...
	export default {
		...
		methods: {
			...
			confirm() {
				updateProductCommission(this.frme).then(res => {
