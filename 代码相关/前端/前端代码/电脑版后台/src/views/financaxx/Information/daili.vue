            ...
            <!-- <el-table-column align="center" label="操作" width="100" class-name="small-padding fixed-width">
                <template slot-scope="scope">
                    ...
                    <el-button @click="updataClick(scope.row)" type="text" size="small"
                        v-hasPermi="['channel:channelManagement:edit']">调整余额</el-button>
...
<script>
    import { selectChildAgentList, deleteAgentAccount, updateBalance, updateAgentStatus, selectWithdrawalRecordDetailsListPage, updateAgentEncryptStatus } from "@/api/monitor/business";
    export default {
        name: "Products",
        ...
        methods: {
            ...
            getList() {
                selectChildAgentList(this.queryParams).then((res) => {
                    if (res.data) {
                        this.list = res.data
                    } else {
                        this.list = []
