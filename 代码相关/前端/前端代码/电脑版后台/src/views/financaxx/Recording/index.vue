<template>
    <div class="app-container">
        ...
        <el-table ref="tables" v-loading="loading" :data="list" row-key="operatorReportId" border lazy
            ...
            <el-table-column label="ID" align="center" prop="applicationNumber" />
            ...
            <el-table-column label="失败原因" align="center" prop="contactSignPeople" :show-overflow-tooltip="true" />
...
<script>
    import { selectAgentWithdrawalApplicationListPage } from "@/api/monitor/finance";
    export default {
        name: "Products",
        ...
        methods: {
            ...
            getList() {
                selectAgentWithdrawalApplicationListPage(this.queryParams).then((res) => {
                    if (res.data.rows) {
