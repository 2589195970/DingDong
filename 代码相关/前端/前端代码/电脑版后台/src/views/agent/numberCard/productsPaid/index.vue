<template>
    <div class="app-container">
        ...
        <el-table ref="tables" v-loading="loading" :data="list" row-key="operatorReportId" border lazy :max-height="tableMaxHeight">
            ...
            <el-table-column label="提卡费" align="center" width="140">
                <template slot-scope="scope">
                    <div v-if="supportsCardFee(scope.row)" class="card-fee-cell">
                        ...
                        <p>利润：
                            <span
                                ...
                                {{ formatAmount(scope.row.cardFeeProfit) }} 元
                            </span>
                        </p>
                        <div class="card-fee-actions">
                            <el-button type="text" size="mini" @click="handleCardFee(scope.row)">调整提卡费</el-button>
                        </div>
                    </div>
                    <span v-else>--</span>
                </template>
